...
namespace Photon.Pun.Demo.PunBasics
{
    ...
    public class Launcher : MonoBehaviourPunCallbacks
    {
        ...
        public override void OnConnectedToMaster()
        {
            ...
            if (isConnecting)
            {
                LogFeedback("执行顺序01，OnConnectedToMaster: Next -> try to Join Random Room");
                Debug.Log(
        ...
        {
            LogFeedback("之心顺序02<Color=Red>OnJoinRandomFailed</Color>: Next -> Create a new Room");
            Debug.Log(
        ...
        {
            LogFeedback("执行顺序03，<Color=Red>OnDisconnected</Color> " + cause);
